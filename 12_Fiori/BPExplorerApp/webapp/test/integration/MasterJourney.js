sap.ui.define([
		...
		opaTest("MasterList Filtering on Balance less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("<Balance>").
		...
		opaTest("MasterList Filtering on Balance more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 <Currency>").
				and.iPressOKInViewSelectionDialog();
