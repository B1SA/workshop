		...
		"dependencies" : {
		 ...
		 "config" : {
			...
			"serviceConfig" : {
				...
				//Optional TODO: Please replace your Service Layer HOST her
				//Actually, it doesn't really matter here, as the service Layer is accessed via XSJS.
				serviceUrl: "https://<YOUR_ServiceLayer_HOST>:50000/b1s/v1/"
			}
		},
		routing: {
			config: {
